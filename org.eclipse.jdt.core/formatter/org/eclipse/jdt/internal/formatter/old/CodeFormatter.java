...
public CodeFormatter(Map<String,String> options) {
	if (options == null) {
...
public String format(String string, int indentLevel, int[] positions, String lineSeparator) {
	...
	Map<String,String> newOptions = DefaultCodeFormatterConstants.getEclipse21Settings();

	String formatterNewLineOpeningBrace = this.options.get(JavaCore.FORMATTER_NEWLINE_OPENING_BRACE);
	...
	String formatterNewLineControl = this.options.get(JavaCore.FORMATTER_NEWLINE_CONTROL);
	...
	String formatterClearBlankLines = this.options.get(JavaCore.FORMATTER_CLEAR_BLANK_LINES);
	...
	String formatterNewLineElseIf = this.options.get(JavaCore.FORMATTER_NEWLINE_ELSE_IF);
	...
	String formatterNewLineEmptyBlock = this.options.get(JavaCore.FORMATTER_NEWLINE_EMPTY_BLOCK);
	...
	String formatterCompactAssignment = this.options.get(JavaCore.FORMATTER_COMPACT_ASSIGNMENT);
